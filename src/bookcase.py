...
class Bookcase:
    ...
    def __init__(cls, id: int):
        ...
        for i in bookshelf_p.find_all("a"):
            if bool(fast_regex(r"https://www.wenku8.net/modules/article/readbookcase.php\?aid=(\d*)&bid=\d*(?!.)", i.get("href"))):
                cls.books.append(int(
                    fast_regex(r"https://www.wenku8.net/modules/article/readbookcase.php\?aid=(\d*)&bid=\d*(?!.)", i.get("href"))))
